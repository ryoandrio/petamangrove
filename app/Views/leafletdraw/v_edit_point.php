            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('leafletdraw/simpan_edit_data_point'); ?>" method="POST">
                        ...
                        <label for="edit_point_nama">Nama</label>
                        <input type="text" class="form-control" id="edit_point_nama" name="edit_point_nama">

                        <label for="edit_point_deskripsi">Deskripsi</label>
                        <input type="text" class="form-control" name="edit_point_deskripsi" id="edit_point_deskripsi" rows="2">
                </div>
                <div class="modal-footer">
            ...
            onEachFeature: function(feature, layer) {
                layer.on({
                    click: function(e) {
                        ...
                        $('#edit_point_nama').val(feature.properties.nama);
