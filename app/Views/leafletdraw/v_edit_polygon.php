            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('leafletdraw/simpan_edit_data_polygon'); ?>" method="POST">
                        ...
                        <label for="edit_polygon_nama">Nama</label>
                        <input type="text" class="form-control" id="edit_polygon_nama" name="edit_polygon_nama">

                        <label for="edit_polygon_deskripsi">Deskripsi</label>
                        <input type="text" class="form-control" name="edit_polygon_deskripsi" id="edit_polygon_deskripsi" rows="2">
                </div>
                <div class="modal-footer">
            ...
            onEachFeature: function(feature, layer) {
                layer.on({
                    click: function(e) {
                        ...
                        $('#edit_polygon_nama').val(feature.properties.nama);
